defmodule PartbWeb.ProductLiveTest do
  use PartbWeb.ConnCase

  import Phoenix.LiveViewTest
  import Partb.StoreSystemFixtures

  @create_attrs %{current_inventory_count: 42, product_name: "some product_name", vendor_name: "some vendor_name", wholesale_price: 42}
